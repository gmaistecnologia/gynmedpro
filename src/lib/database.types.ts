...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      carteira_medicos: {
        Row: {
          ...
          id: string
          medico_nome: string
          medico_nome_normalizado: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "carteira_medicos_criado_por_fkey"
            columns: ["criado_por"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "carteira_medicos_representante_id_fkey"
    ...
    Functions: {
      ...
      reconciliar_representante_id: { Args: never; Returns: number }
      registrar_login: { Args: never; Returns: undefined }
      representante_efetivo_id: {
        Args: {
          rec: Database["public"]["Tables"]["solicitacoes_importadas"]["Row"]
        }
        Returns: string
      }
      representante_efetivo_nome: {
        Args: {
          rec: Database["public"]["Tables"]["solicitacoes_importadas"]["Row"]
        }
        Returns: string
